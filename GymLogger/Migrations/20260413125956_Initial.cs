    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgramsDay", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProgramsDay_TrainingPrograms_ProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgramsDayExercises", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProgramsDayExercises_Exercises_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProgramsDayExercises_ProgramsDay_ProgramDayId",
                        column: x => x.ProgramDayId,
                        principalTable: "ProgramsDay",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgramsDay_ProgramId",
                table: "ProgramsDay",
                column: "ProgramId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgramsDayExercises_ExerciseId",
                table: "ProgramsDayExercises",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_ProgramsDayExercises_ProgramDayId",
                table: "ProgramsDayExercises",
                column: "ProgramDayId");
